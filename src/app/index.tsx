...
const styles = StyleSheet.create({
  ...
  featuredTitle: { color: Gold.text, fontFamily: 'LibreBaskerville_700Bold', fontSize: 19, lineHeight: 26, letterSpacing: -0.3 },
  featuredSub: { color: Gold.textMuted, fontFamily: 'LibreBaskerville_400Regular', fontSize: 13, lineHeight: 20, marginTop: 6 },
  ...
  rowTitle: { color: Gold.text, fontFamily: 'LibreBaskerville_700Bold', fontSize: 13, lineHeight: 18 },
